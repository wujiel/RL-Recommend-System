...
if __name__ == "__main__":
    ...
    ratings_df_look1 = ratings_df.head()
    ...
    ratings_df_look2 = ratings_df.head()


    # 유저별로 본 영화들 순서대로 정리
    users_dict = np.load(r"data\user_dict.npy",
                         allow_pickle=True)

    # 각 유저별 영화 히스토리 길이
    users_history_lens = np.load(
        r"data\users_histroy_len.npy")
