...
class DdpgActor(object):
    ...
    def build_networks(self):
        #  Build networks
        self.mean_network(numpy.zeros((1, 3*self.embedding_dim)))
        self.target_mean_network(numpy.zeros((1, 3*self.embedding_dim)))
        self.logvar_network(numpy.zeros((1, 3*self.embedding_dim)))
        self.target_logvar_network(numpy.zeros((1, 3*self.embedding_dim)))
...
# actor
class Actor(object):
    def __init__(self, state_dim, hidden_dim,action_dim, learning_rate, state_size, target_network_update_rate):
